...
<head>
    ...
    <style>
        ...
        include '../public/assets/vendor/bootstrap/css/bootstrap.min.css';
        include '../public/assets/vendor/bootstrap/css/bootstrap.min.css';
        include '../public/assets/vendor/fonts/circular-std/style.css';
        include '../public/assets/libs/css/style.css';
        include '../public/assets/vendor/fonts/fontawesome/css/fontawesome-all.css';
        include '../public/assets/vendor/jvectormap/jquery-jvectormap-2.0.2.css';
        include '../public/assets/vendor/fonts/flag-icon-css/flag-icon.min.css';
